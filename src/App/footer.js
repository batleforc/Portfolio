    ...
    render(){
        return(
         ...
         <div  style={{textAlign:"center"}}>
           ...
           <p className="w3-medium">Powered by <a href="https://www.w3schools.com/w3css/default.asp" target="_blank" rel="noreferrer noopener" className="w3-hover-text-green">w3.css</a>
